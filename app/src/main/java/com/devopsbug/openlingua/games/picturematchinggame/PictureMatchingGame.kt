...
//        )
        val currentScreen = backStackEntry?.destination?.route ?: gameScreens.first()
        ...
        NavHost(
            ...
            startDestination = gameScreens[0], //PictureMatchingGameScreen.start.name,
        ) {
            composable(route = gameScreens[0]){ //PictureMatchingGameScreen.start.name) {
                Log.d(TAG, "navHost Calling route = ${gameScreens[0]}")
                ExplorePicturesScreen(
                    currentLanguage = currentLanguage,
                    currentPictureGameCategory = pictureMatchingGameUiState.currentPictureGameCategory,
                    continueToNextScreen = { navController.navigate(gameScreens[1]) }
                )
            }
...
//                )
//            }
            composable(route = gameScreens[1]) {
                Log.d(TAG, "navHost: Calling route = ${gameScreens[1]}")
                RandomPictureScreen(
                    currentLanguage = currentLanguage,
                    //currentPictureGameCategory = pictureMatchingGameUiState.currentPictureGameCategory,
...
//    @Composable
//    override fun <VM : ViewModel, S> GameNavigation(
//        navController: NavHostController,
//        gameViewModel: VM,
//        gameUiState: S
//    ) {
//        gameViewModel as PictureMatchingGameViewModel
//        gameUiState as PictureMatchingGameUiState
//
//        NavHost(
//            navController = navController,
...
//                ExplorePicturesScreen(
//                    currentLanguage = currentLanguage,
//                    currentPictureGameCategory = gameUiState.currentPictureGameCategory,
//                    continueToNextScreen = { navController.navigate(PictureMatchingGameScreen.random.name) }
//                )
//            }
//            composable(route = PictureMatchingGameScreen.explore.name) {
...
//                    //currentPictureGameCategory = pictureMatchingGameUiState.currentPictureGameCategory,
//                    //currentWrongGameAssets = pictureMatchingGameUiState.currentWrongGameAssets,
//                    currentCorrectGameAsset = gameUiState.currentCorrectGameAsset,
//                    randomizedGameAssetDisplayList = gameUiState.randomizedGameAssetDisplayList,
//                    newRandomPicture = { gameViewModel.newRandomPicture() },
//                )
//            }
//        }
//    }
